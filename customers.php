...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <a href="javascript:void(0)" onclick="toggle_visibility('popup-box1')"><input type="button" id="btnadd" value="+ Add Customers" /></a>
        </td>
      
        <td width="50" align="right">
        
        <form action="exportcustomers.php" method="get" ecntype="multipart/data-form">
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%" style="border:1px solid #033; color:#033;">
     ...
     <tr>
     <th colspan="6" align="center" height="55px" style="border-bottom:1px solid #033; background: #033; color:#FFF;"> Customer Information Table</th>
    </tr>
