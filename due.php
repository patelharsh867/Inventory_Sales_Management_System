...
<table width="83%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <input type="text" name="query" style="border:1px solid #CCC; color: #333; width:210px; height:30px;" placeholder="Search..." /><input type="submit" id="btnsearch" value="Search" name="search" />
        </form>
        
        </td>
        
        <td width="131" height="37">
        <a href="javascript:void(0)" onclick="toggle_visibility('popup-box1')"><input type="button" id="btnadd" value="+ Add Dues" /></a>
        </td>

        <td width="50" align="right">
        
        <form action="exportdue.php" method="get" ecntype="multipart/data-form">
