...
<script type="text/javascript">
        ...
        navigator: {
            enabled: 'true'
                ...
                $.getJSON("Externaldata.php", function(json) {
...
<select name="myselect" onchange="redirectMe(this);">
 <option value="chart3.php" >Total Quantity chart</option>
    <option value="Hardwarechart.php" >Hardware Sales</option>
    <option value="Softwarechart.php">Software Sales</option>
    <option value="Externalchart.php" selected>External Accessories Sales</option>
