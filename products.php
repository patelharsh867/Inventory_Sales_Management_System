...
<table width="83%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <form action="export.php" method="get" ecntype="multipart/data-form">
...
while ($row=mysqli_fetch_array($result)){?>
      ...
      <tr align="center" style="height:25px">
        ...
        <td style="border-bottom:1px solid #333; width:150px !important;"> <?php echo "<img src='".$row['img']."' height = 150 width= 150 />"; ?> </td>
